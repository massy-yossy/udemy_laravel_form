                            ...
                            <div class="p-2 w-full">
                              <div class="relative">
                                ...
                                <select name="age">
                                  ...
                                  <option value="2" {{ old('gender') == 2 ? 'selected' : ''}}>20-29歳</option>
                                  <option value="3" {{ old('gender') == 3 ? 'selected' : ''}}>30-39歳</option>
                                  <option value="4" {{ old('gender') == 4 ? 'selected' : ''}}>40-49歳</option>
                                  <option value="5" {{ old('gender') == 5 ? 'selected' : ''}}>50-59歳</option>
                                  <option value="6" {{ old('gender') == 6 ? 'selected' : ''}}>60-歳</option>
                                </select>
                              </div>
                            </div>
                            <div class="p-2 w-full">
