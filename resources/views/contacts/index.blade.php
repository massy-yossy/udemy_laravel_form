            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="lg:w-2/3 w-full mx-auto overflow-auto">
                        <form class="mb-5" method="GET" action="{{ route('contacts.index') }}">
                            <input type="text" name="search" class="mr-5" placeholder="検索する">
                        ...
                        <table class="table-auto w-full text-left whitespace-no-wrap">
                            ...
                            <tbody>
                                @foreach($contacts as $contact)
                                  ...
                                  <td class="border-t-2 border-gray-200 px-4 py-3 text-gray-900"><a class="text-blue-500" href="{{ route('contacts.show', ['id' => $contact->id]) }}">詳細を見る</a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
